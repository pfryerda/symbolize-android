...
abstract public class PuzzleDB {
    ...
    private static final int[] xml_map = new int[]{
        ...
        R.xml.level_1_8, R.xml.level_1_9, R.xml.level_1_10,
        ...
        R.xml.level_2_8, R.xml.level_2_9, R.xml.level_2_10,
        ...
        R.xml.level_3_8, R.xml.level_3_9, R.xml.level_3_10,
    ...
    private static Level fetch_level() {
        ...
        try {
            ...
            if( !xpp.getName().equals( "unlocks" ) ) {
                bail_invalid_check( "unlocks" );
            }
            unlocks = new ArrayList<Byte>();
            xpp.next();
            while( !xpp.getName().equals( "unlocks" ) ) {
                if( !xpp.getName().equals( "unlock" ) ) {
                    bail_invalid_check( "unlock" );
                }
                xpp.next();
